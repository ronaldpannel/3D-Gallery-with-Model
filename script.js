...
// const helper2 = new THREE.DirectionalLightHelper(directionalLight1, 5);
// scene.add(helper2);
...
const spotLight = new THREE.SpotLight(0xffffff,15,17,Math.PI/3, 0.3, 0.2);
...
const mLoader = new GLTFLoader().setPath("/frank/");
mLoader.load("scene.gltf", (gltf) => {
